...
const RegisterScreen = () => {
    ...
    const handleEmailBlur = async () => {
        ...
        try {
            const response = await axios.get('http://192.168.2.72:5000/api/accounts/check-email', {
                params: { email },
            });
    ...
    const handleSendOtp = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post('http://192.168.2.72:5000/api/accounts/register-step1', { email });
